            ...
            <div className="border-t border-gray-200 pt-6">
              <div className="flex items-center mb-3">
                ...
                <span className="text-gray-600">
                  Free delivery on orders above ₹999 in {product.city === 'both' ? 'Ghaziabad & Noida' : product.city}
                </span>
              </div>
              <div className="flex items-center mb-3">
        ...
        <Tabs defaultValue="details" className="mb-16">
          ...
          <TabsContent value="details" className="py-6">
            <div className="prose max-w-none">
              ...
              <ul>
                <li><strong>Origin:</strong> {product.origin || 'Premium quality'}</li>
                <li><strong>Shelf Life:</strong> {product.shelfLife || '6 months from packaging'}</li>
            ...
            <div className="prose max-w-none">
              ...
              <div className="border border-gray-200 rounded-lg p-4">
                {product.nutritionalInfo ? (
                  <div dangerouslySetInnerHTML={{ __html: product.nutritionalInfo.replace(/\n/g, '<br>') }} />
                ) : (
          ...
          <TabsContent value="reviews" className="py-6">
            <div className="prose max-w-none">
              ...
              <div className="flex items-center mb-4">
                ...
                <span className="text-lg font-medium">{product.ratings} out of 5</span>
              </div>
